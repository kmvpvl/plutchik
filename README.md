...
## How to manage content by TG
User with role `manage_content` can edit content by Telegram bot. Simple send formatted text to bot. Bot notifies user if content item added successfully. Most commands use `:` as separator
|Command|Syntax|Example|
|-|-|-|
|Add text content item|text:\<language>:\<header>:\<text>\[:group]|text:en:Helpfulness:I have been impressed by the knowledge and helpfulness of the staff|
|Add image content item|img:\<language>:\<header>:\<url>\[:group]|mg:en:Right diet:I’m on seafood diet:https://img.delicious.com.au/WqbvXLhs/del/2016/06/more-the-merrier-31380-2.jpg|
|Add YT video|\<url_to_youtube>||
|Assign content group to user|/assign \<group_name> \<utg_ser_id>|/assign test 191960423|
